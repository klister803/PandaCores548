...
-- Healing Sphere
REPLACE INTO areatrigger_data (entry, scale, activationDelay, updateDelay, maxCount, comment) VALUES
...
INSERT INTO `areatrigger_data` (`entry`, `visualId`, `scale`, `activationDelay`, `updateDelay`, `maxCount`, `comment`) VALUES 
...
INSERT INTO `areatrigger_data` (`entry`, `scale`, `activationDelay`, `updateDelay`, `maxCount`, `comment`) VALUES 
...
REPLACE INTO `areatrigger_data` (`entry`, `visualId`, `scale`, `activationDelay`, `updateDelay`, `maxCount`, `comment`) 
