DELETE FROM `spell_script_names` WHERE (`spell_id`='20271') AND (`ScriptName`='spell_pal_judgment');
INSERT INTO `spell_linked_spell` (`spell_trigger`, `spell_effect`, `hastalent`, `comment`) VALUES ('20271', '111528', '111529', 'Paladin - Judgments of the Bold');
