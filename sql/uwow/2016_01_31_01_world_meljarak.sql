...
update creature_template set minlevel = 90, maxlevel = 90, faction = 14, unit_flags = 524288, ScriptName = 'npc_meljarak_amber_prison' where entry = 62531;
...
delete from conditions where SourceTypeOrReferenceId = 13 and SourceEntry in (131813,122354,125935,125936);
