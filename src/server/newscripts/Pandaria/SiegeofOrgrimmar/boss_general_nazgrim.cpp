...
public:
    ...
    struct npc_korkron_archweaverAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* who)
        {
            ...
            events.ScheduleEvent(EVENT_MAGI_STRIKE, 10000);
            events.ScheduleEvent(EVENT_UNSTABLE_BLINK, 15000);
        }
...
public:
    ...
    struct npc_korkron_warshamanAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* who)
        {
            ...
            events.ScheduleEvent(EVENT_HEALING_TOTEM, 8000);
        }
        ...
        void UpdateAI(uint32 diff)
        {
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                ...
                case EVENT_EARTH_SHIELD:
                    ...
                    events.ScheduleEvent(EVENT_EARTH_SHIELD, 15000);
                    break;
                ...
                case EVENT_HEALING_TOTEM:
                    ...
                    events.ScheduleEvent(EVENT_HEALING_TOTEM, 25000);
                    break;
                }
            }
            DoMeleeAttackIfReady();
...
public:
    ...
    struct npc_ravagerAI : public ScriptedAI
    {
        ...
        void MovementInform(uint32 type, uint32 pointId)
        {
            if (type == POINT_MOTION_TYPE)
                if (pointId == 1)
                    events.ScheduleEvent(EVENT_IN_POINT, urand(5000, 10000));
        }
