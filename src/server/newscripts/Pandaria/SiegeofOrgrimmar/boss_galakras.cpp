            ...
            void DoAction(int32 const action)
            {
                switch (action)
                {
                    ...
                    case ACTION_DEMOLITIONS_SOUTH:
                        events.ScheduleEvent(EVENT_SUMMON_DEMOLITIONS_SOUTH, 40000);
                        break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_GALAKRAS_INTRO:
                        {
                            ...
                            events.ScheduleEvent(EVENT_SUMMON_DEMOLITIONS_SOUTH, 0);
                            break;
                        }
                        ...
                        case EVENT_SUMMON_ADDS_1:
                            ...
                            events.ScheduleEvent(EVENT_SUMMON_ADDS_2, 55000);
                            break;
                        ...
                        case EVENT_SUMMON_ADDS_4:
                            ...
                            me->SummonCreature(NPC_DRAGONMAW_PROTO_DRAKE, AddsSpawn[0].GetPositionX() - 2.0f, AddsSpawn[0].GetPositionY(), AddsSpawn[0].GetPositionZ() + 1.0f, AddsSpawn[0].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 10000);
                            events.ScheduleEvent(EVENT_SUMMON_ADDS_5, 55000);
                            break;
                        ...
                        case EVENT_SUMMON_ADDS_8:
                            ...
                            events.ScheduleEvent(EVENT_SUMMON_ADDS_9, 55000);
                            break;
                        case EVENT_SUMMON_ADDS_9:
                            me->SummonCreature(NPC_DRAGONMAW_PROTO_DRAKE, AddsSpawn[0].GetPositionX() + 2.0f, AddsSpawn[0].GetPositionY(), AddsSpawn[0].GetPositionZ() + 1.0f, AddsSpawn[0].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 10000);
                            me->SummonCreature(NPC_DRAGONMAW_PROTO_DRAKE, AddsSpawn[0].GetPositionX() - 2.0f, AddsSpawn[0].GetPositionY(), AddsSpawn[0].GetPositionZ() + 1.0f, AddsSpawn[0].GetOrientation(), TEMPSUMMON_CORPSE_TIMED_DESPAWN, 10000);
                            events.ScheduleEvent(EVENT_SUMMON_ADDS_10, 55000);
                            break;
                        ...
                        case EVENT_GALAKRAS_EXECUTE_1:
                            ...
                            events.ScheduleEvent(EVENT_GALAKRAS_EXECUTE_2, 4000);
                            break;
                        case EVENT_GALAKRAS_EXECUTE_2:
                            me->SetReactState(REACT_AGGRESSIVE);
                            me->RemoveByteFlag(UNIT_FIELD_BYTES_1, 3, UNIT_BYTE1_FLAG_HOVER);
                            events.ScheduleEvent(EVENT_GALAKRAS_EXECUTE_3, 0);
                            events.ScheduleEvent(EVENT_GALAKRAS_EXECUTE_4, 20000);
                            break;
                        ...
                        case EVENT_GALAKRAS_EXECUTE_4:
                            ...
                            events.ScheduleEvent(EVENT_GALAKRAS_EXECUTE_4, 25000);
                            break;
                    }
                }
...
class npc_jaina_or_sylvana : public CreatureScript
{
    public:
        ...
        struct npc_jaina_or_sylvanaAI : public ScriptedAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                events.ScheduleEvent(EVENT_JAINAORSYLVANA_COMBAT_1, 1000);
                events.ScheduleEvent(EVENT_JAINAORSYLVANA_COMBAT_2, 5000);
                events.ScheduleEvent(EVENT_JAINAORSYLVANA_COMBAT_3, 15000);
            }
    ...
    public:
        ...
        struct npc_verees_or_aethasAI : public ScriptedAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                ...
                events.ScheduleEvent(EVENT_VEREESORAETHAS_COMBAT_2, 5000);
            }
    ...
    public:
        ...
        struct npc_demolitionsAI : public npc_escortAI
        {
            ...
            void IsSummonedBy(Unit* summoner)
            {
                ...
                events.ScheduleEvent(EVENT_BANTER_GRUNT, 1000);
                events.ScheduleEvent(EVENT_KNOCKED_OVER, 1000);
            ...
            void WaypointReached(uint32 id)
            {
                if (SouthExpert)
                    ...
                    {
                        ResetCast = true;
                        events.ScheduleEvent(EVENT_REPEAT_DEMO_CAST, 1000);
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_KNOCKED_OVER:
                            ...
                            events.ScheduleEvent(EVENT_KNOCKED_OVER, 500);
                            break;
                    }
                }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_SUMMON_FLY_PROTODRAKE_1:
                            ...
                            me->SummonCreature(NPC_DRAGONMAW_PROTO_DRAKE, ProtoDrake[urand(0,9)], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 5000);
                            events.ScheduleEvent(EVENT_SUMMON_FLY_PROTODRAKE_2, 5000);
                            break;
                        case EVENT_SUMMON_FLY_PROTODRAKE_2:
                            me->SummonCreature(NPC_DRAGONMAW_PROTO_DRAKE, ProtoDrake[urand(0,9)], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 5000);
                            me->SummonCreature(NPC_DRAGONMAW_PROTO_DRAKE, ProtoDrake[urand(0,9)], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 5000);
                            events.ScheduleEvent(EVENT_SUMMON_FLY_PROTODRAKE_3, 5000);
                            break;
                        case EVENT_SUMMON_FLY_PROTODRAKE_3:
                            me->SummonCreature(NPC_DRAGONMAW_PROTO_DRAKE, ProtoDrake[urand(0,9)], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 5000);
                            me->SummonCreature(NPC_DRAGONMAW_PROTO_DRAKE, ProtoDrake[urand(0,9)], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 5000);
                            me->SummonCreature(NPC_DRAGONMAW_PROTO_DRAKE, ProtoDrake[urand(0,9)], TEMPSUMMON_CORPSE_TIMED_DESPAWN, 5000);
                            events.ScheduleEvent(EVENT_SUMMON_FLY_PROTODRAKE_4, 5000);
                            break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_THUNDER_CLAP:
                            ...
                            events.ScheduleEvent(EVENT_THUNDER_CLAP, 15000);
                            break;
                    }
                }
                DoMeleeAttackIfReady();
        ...
        struct npc_dragonmaw_proto_drakeAI : public ScriptedAI
        {
            ...
            void IsSummonedBy(Unit* summoner)
            {
                if (summoner->GetEntry() == NPC_GALAKRAS)
                    events.ScheduleEvent(EVENT_PROTO_DRAKE_GROUND, 1000);
                
                if (summoner->GetEntry() == NPC_TOWER_SOUTH)
                    events.ScheduleEvent(EVENT_PROTO_DRAKE_FLY, 1000);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_DRAKE_DRAKEFIRE:
                            ...
                            events.ScheduleEvent(EVENT_DRAKE_DRAKEFIRE, 45000);
                            break;
                    }
                }
                if (!me->HasUnitState(UNIT_STATE_CASTING))
...
class npc_dragonmaw_grunt_h : public CreatureScript
{
    public:
        ...
        struct npc_dragonmaw_grunt_hAI : public ScriptedAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                events.ScheduleEvent(EVENT_DRAGON_CLEAVE, 5000);
            }
...
class npc_dragonmaw_flameslinger : public CreatureScript
{
    public:
        ...
        struct npc_dragonmaw_flameslingerAI : public ScriptedAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                events.ScheduleEvent(EVENT_FLAMESLINGER_ATTACK, 0);
                DoZoneInCombat(me, 150);
            }
            ...
            void DoAction(const int32 action)
            {
                if (action == ACTION_TOWER_GUARDS)
                {
                    events.ScheduleEvent(EVENT_FLAMESLINGER_ATTACK, 1000);
...
class npc_dragonmaw_flagbearer : public CreatureScript
{
    public:
        ...
        struct npc_dragonmaw_flagbearerAI : public ScriptedAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                events.ScheduleEvent(EVENT_WAR_BANNER, 15000);
                DoZoneInCombat(me, 30.0f);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_WAR_BANNER:
                            ...
                            events.ScheduleEvent(EVENT_WAR_BANNER, 30000);
                            break;
                    }
                }
                DoMeleeAttackIfReady();
...
class npc_dragonmaw_bonecrusher : public CreatureScript
{
    public:
        ...
        struct npc_dragonmaw_bonecrusherAI : public ScriptedAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                events.ScheduleEvent(EVENT_SHATTERING_ROAR, 9000);
                events.ScheduleEvent(EVENT_FRACTURE, 51000);
                DoZoneInCombat(me, 30.0f);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_TIDE_TOTEM:
                            ...
                            events.ScheduleEvent(EVENT_TIDE_TOTEM, 18000, true);
                            break;
                    }
                }
                if (!me->HasUnitState(UNIT_STATE_CASTING))
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_VENOM_BOLT_VOLLEY:
                            ...
                            events.ScheduleEvent(EVENT_VENOM_BOLT_VOLLEY, urand(3000, 4000));
                            break;
                    }
                }
                if (!me->HasUnitState(UNIT_STATE_CASTING))
...
class npc_dragonmaw_ebon_stalker : public CreatureScript
{
    public:
        ...
        struct npc_dragonmaw_ebon_stalkerAI : public ScriptedAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                events.ScheduleEvent(EVENT_SHADOW_STALK, 15000);
                events.ScheduleEvent(EVENT_SHADOW_ASSAULT, 16000);
                DoZoneInCombat(me, 30.0f);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        case EVENT_SHADOW_STALK:
                            ...
                            events.ScheduleEvent(EVENT_SHADOW_STALK, 10000);
                            break;
                        case EVENT_SHADOW_ASSAULT:
                            DoCast(SPELL_SHADOW_ASSAULT);
                            events.ScheduleEvent(EVENT_SHADOW_ASSAULT, 10000);
                            break;
                    }
                }
                if (!me->HasUnitState(UNIT_STATE_CASTING))
