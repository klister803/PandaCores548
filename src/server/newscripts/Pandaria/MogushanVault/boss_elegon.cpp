            ...
            void ChangePhase(uint8 newPhase)
            {
                ...
                switch (newPhase)
                {
                    ...
                    case PHASE_THREE:
                    {
                        ...
                        events.ScheduleEvent(EVENT_ENERGY_CASCADE, 5000);
                        events.ScheduleEvent(EVENT_DISABLE_PLATFORM, 10000);
                        break;
                    }
                    case PHASE_FOUR:
            ...
            void UpdateAI(uint32 diff)
            {
                ...
                switch (events.ExecuteEvent())
                {
                    ...
                    case EVENT_ENERGY_CASCADE:
                        ...
                        events.ScheduleEvent(EVENT_ENERGY_CASCADE, 4000);
                        break;
                    case EVENT_DISABLE_PLATFORM:
                        instance->HandleGameObject(instance->GetData64(GOB_ENERGY_PLATFORM), true);
                        break;
