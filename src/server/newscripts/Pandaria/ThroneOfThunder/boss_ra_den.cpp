    ...
    public:
        ...
        struct boss_ra_denAI : public BossAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                _EnterCombat();
                checkpower = 1000;
                events.ScheduleEvent(EVENT_MATERIALS_OF_CREATION, 12000);
            ...
            void UpdateAI(uint32 diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    ...
                    case EVENT_MATERIALS_OF_CREATION:
                        ...
                        events.ScheduleEvent(EVENT_MATERIALS_OF_CREATION, 35000);
                        break;
                    case EVENT_SUMMON:
                        ...
                        events.ScheduleEvent(EVENT_SUMMON, 41000);
                        break;
...
class npc_crackling_stalker : public CreatureScript
{
    public:
        ...
        struct npc_crackling_stalkerAI : public ScriptedAI
        {
            ...
            {
                DoZoneInCombat(me, 100.0f);
                events.ScheduleEvent(EVENT_CRACKLE, 10000);
            }
            ...
            void UpdateAI(uint32 diff)
            {
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    if (eventId == EVENT_CRACKLE)
                    {
                        ...
                        events.ScheduleEvent(EVENT_CRACKLE, 15000);
                    }
                }
                DoMeleeAttackIfReady();
            }
