...
public:
    ...
    struct boss_chagan_firehoofAI : public BossAI
    {
        ...
        {
            _EnterCombat();
            events.ScheduleEvent(EVENT_HAMMER_TIME, 14000);
            events.ScheduleEvent(EVENT_TRAILBLAZE, 8000);
        }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_TRAILBLAZE:
                        ...
                        events.ScheduleEvent(EVENT_TRAILBLAZE, 20000);
                        break;
                }
            }
...
public:
    ...
    struct npc_chagan_batuAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*who*/) 
        {
            events.ScheduleEvent(EVENT_YAK_BASH, 9000);
        }
...
public:
    ...
    struct npc_chagan_trailblazeAI : public ScriptedAI
    {
