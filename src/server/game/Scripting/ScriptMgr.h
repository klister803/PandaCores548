...
template<class TMap> class MapScript : public UpdatableScript<TMap>
{
    ...
    protected:
        ...
        {
            if (!_mapEntry)
                TC_LOG_ERROR("server", "Invalid MapScript for %u; no such map ID.", mapId);
        }
...
class AchievementRewardScript : public ScriptObject
{
    ...
    public:
        ...
        virtual uint32 SelectTitle(Player* /*source*/, AchievementReward const* /*data*/) { return 0; };
...
class PlayerScript : public ScriptObject
{
    ...
    public:
        ...
        virtual void OnPlayerDeath(Player* /*deadPlayer*/) {}
...
class ScriptMgr
{
    ...
    public: /* AchievementRewardScript */
        ...
        uint32 OnSelectTitleReward(AchievementReward const* data, Player* source);
