...
class World
{
    public:
        ...
        PlayerPtr FindPlayerInZone(uint32 zone);
        ...
        void SendServerMessage(ServerMessageType type, const char *text = "", PlayerPtr player = nullptr);
        ...
        void ShutdownCancel();
        void ShutdownMsg(bool show = false, PlayerPtr player = nullptr);
