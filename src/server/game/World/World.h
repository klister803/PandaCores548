...
enum WorldBoolConfigs
{
    ...
    CONFIG_WARDEN_ENABLED_DYNAMIC_CHECKS,
    CONFIG_WARDEN_ENABLE_CHECK_BAD_VERSION,
    CONFIG_WARDEN_USES_EXP_SYSTEM,
    CONFIG_WARDEN_USES_Z_AXIS_CHECK,
    ...
    CONFIG_CUSTOM_CONTENT_ENABLED,
    CONFIG_DAMAGE_ENABLE_FROM_DBC,
    CONFIG_FASTER_LOADING,
    CONFIG_CUSTOM_BATTLEGROUND,
    CONFIG_CUSTOM_X20,
    CONFIG_CUSTOM_FOOTBALL,
...
enum WorldFloatConfigs
{
    ...
    CONFIG_WARDEN_Z_AXIS_DELTA,
    CONFIG_WARDEN_MAX_TP_DIST,
...
enum WorldIntConfigs
{
    ...
    CONFIG_CURRENCY_CONQUEST_POINTS_RBG_REWARD,
    CONFIG_CURRENCY_VALOR_FOR_CHALLENGE_NO_MEDAL,
    CONFIG_CURRENCY_VALOR_FOR_CHALLENGE_BRONZ,
    CONFIG_CURRENCY_VALOR_FOR_CHALLENGE_SILVER,
    CONFIG_CURRENCY_VALOR_FOR_CHALLENGE_GOLD,
    CONFIG_CURRENCY_VALOR_FOR_CHALLENGE_PLATINUM,
    ...
    CONFIG_WARDEN_CLIENT_RESPONSE_DELAY_ALERTS,
    CONFIG_WARDEN_NUM_SPEED_ALERTS,
    CONFIG_WARDEN_NUM_SPEED_EXT_ALERTS,
    CONFIG_WARDEN_NUM_MOVEFLAGS_ALERTS,
    CONFIG_WARDEN_NUM_FALIED_COORDS_ALERTS,
...
//        uint16 m_averageLongUpdateTime[10]; // average update time of 10 m_updateTimeSum
        ...
        static bool m_EnableMvAnticheatDebug;
