...
void GameEventMgr::RunSmartAIScripts(uint16 event_id, bool activate)
{
    ...
    {
        HashMapHolder<Creature>::ReadGuardType guard(HashMapHolder<Creature>::GetLock());
    ...
    {
        HashMapHolder<GameObject>::ReadGuardType guard(HashMapHolder<GameObject>::GetLock());
