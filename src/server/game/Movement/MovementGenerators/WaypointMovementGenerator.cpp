...
void WaypointMovementGenerator<Creature>::LoadPath(Creature &creature)
{
    ...
    if (!i_path)
    {
        ...
        //TC_LOG_ERROR("sql", "WaypointMovementGenerator::LoadPath: creature %s (Entry: %u GUID: %u) doesn't have waypoint path id: %u", creature.GetName(), creature.GetEntry(), creature.GetGUIDLow(), path_id);
        return;
    }
...
void WaypointMovementGenerator<Creature>::OnArrived(Creature& creature)
{
    ...
    {
        TC_LOG_DEBUG("maps", "Creature movement start script %u at point %u for %u.", i_path->at(i_currentNode)->event_id, i_currentNode, creature.GetGUID());
...
void FlightPathMovementGenerator::DoEventIfAny(Player& player, TaxiPathNodeEntry const& node, bool departure)
{
    ...
    {
        TC_LOG_DEBUG("maps", "Taxi %s event %u of node %u of path %u for player %s", departure ? "departure" : "arrival", eventid, node.index, node.path, player.GetName());
