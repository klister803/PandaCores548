...
MovementStatusElements MovementSetCollisionHeightAckSequence[] =
{
    MSEPositionX,
    MSEPositionZ,
    MSEHeight,
    MSECounter, //MSEUnkMoveCounter2,  SequenceIndex
    MSEPositionY,
    MSECounter,
    MSEHasMovementFlags,
    MSEHasPitch,
    ...
    MSEHasTransportData,
    MSEHasFallData,
    MSEBitCounter2, // UpdateCollisionHeightReason ?
    MSEHasMovementFlags2,
    MSEHasGuidByte4,
    MSEHasAlive32,
    MSEBitCounter,
...
MovementStatusElements MovementForceRunSpeedChangeSequence[] =
{
    MSEPositionY,
    MSECounter,
    MSEPositionZ,
...
MovementStatusElements MoeventForceFlightSpeedChangeAckSequence[] =
{
    MSESpeed,
    MSECounter,
    MSEPositionY,
...
MovementStatusElements* GetMovementStatusElementsSequence(Opcodes opcode)
{
    switch (opcode)
    {
        ...
        case CMSG_MOVE_SET_COLLISION_HEIGHT_ACK:
            return MovementSetCollisionHeightAckSequence;
        case CMSG_FORCE_RUN_SPEED_CHANGE_ACK:
            return MovementForceRunSpeedChangeSequence;
        case CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK:
            return MoeventForceFlightSpeedChangeAckSequence;
