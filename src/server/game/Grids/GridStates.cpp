...
void InvalidState::Update(Map &, NGridTypePtr &, GridInfo &, const uint32) const
{
}

void ActiveState::Update(Map &m, NGridTypePtr &grid, GridInfo & info, const uint32 t_diff) const
{
...
void IdleState::Update(Map &m, NGridTypePtr &grid, GridInfo &, const uint32) const
{
...
void RemovalState::Update(Map &m, NGridTypePtr &grid, GridInfo &info, const uint32 t_diff) const
{
