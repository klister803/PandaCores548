...
class Map
{
    ...
    public:
        ...
        bool IsNormalRaid() const { return IsRaid() && (i_difficulty == MAN10_DIFFICULTY || i_difficulty == MAN25_DIFFICULTY); }
    ...
    private:
        ...
        std::unordered_map<uint64 /*dbGUID*/, time_t> _creatureRespawnTimes;
        std::unordered_map<uint64 /*dbGUID*/, time_t> _goRespawnTimes;
