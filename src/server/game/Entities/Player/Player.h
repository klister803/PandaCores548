...
typedef UNORDERED_MAP<uint64, PlayerVignette> PlayerVignettesMap;
...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        static void BuildEnumData(uint32 gid, Json::Value dataValue, ByteBuffer* dataBuffer, ByteBuffer* bitBuffer);
        ...
        void UpdatePlayerCurrency(PlayerCurrency* currency, uint32 id);
        ...
        void UpdatePlayerTalent(uint32 spellId, uint8 specId, bool deleteTal = false, bool deleteSpec = false);
        ...
        void UpdatePlayerQuestRewarded(uint32 questId, bool isDelete = false);
        void InitPlayerQuestDaily();
        void UpdatePlayerQuestDaily(uint32 questId, bool isClear = false);
        void InitPlayerQuestWeekly();
        void UpdatePlayerQuestWeekly(uint32 questId, bool isClear = false);
        void InitPlayerQuestSeasonal();
        void UpdatePlayerQuestSeasonal(uint32 questId, uint32 eventId, bool isRemove = false);
        void InitPlayerBattlePets();
        void SavePlayerBattlePets();
        void UpdatePlayerBattlePets(PetJournalInfo* pjInfo, uint64 guid, bool isDelete = false);
        void SavePlayerBattlePetSlots();
        void SavePlayerArchaeology();
        void InitPlayerReputation();
        void SavePlayerReputation();
        void UpdatePlayerReputation(FactionState* faction);
        void InitPlayerVoidStorage();
        void SavePlayerVoidStorage();
        void UpdatePlayerVoidStorage(uint8 slot);
        void InitPlayerActions();
        void SavePlayerActions();
        void UpdatePlayerAction(uint8 button, uint32 action, uint8 type, uint8 spec, bool isRemove = false);
        void InitPlayerSocial();
        void UpdatePlayerSocial(uint32 friendGuid, std::string note, uint8 flag, bool isNote = false, bool isRemove = false);
        void InitPlayerSpellCooldowns();
        void UpdatePlayerSpellCooldown(uint32 spellId, uint32 itemId, double time, bool isRemove = false, bool isClear = false);
        void InitPlayerKills();
        void UpdatePlayerKill(uint32 victimGuid, uint32 count, bool isClear = false);
        void SavePlayerDeclinedName();
        void InitPlayerEquipmentSets();
        void UpdatePlayerEquipmentSet(uint32 id, EquipmentSet eqset, bool isRemove = false);
        void SavePlayerCUFProfiles();
        void SavePlayerVisuals();
        void InitPlayerAccountData();
        void UpdatePlayerAccountData(AccountDataType type, time_t tm, std::string data);
        void SavePlayerHomeBind();
        void InitAchievement();
        void UpdateAchievement(AchievementEntry const* achievement, CompletedAchievementData* ca);
        void InitCriteria();
        void InitPlayerPets();
        void CreatedPlayerPets();
        void InitPlayerMails();
        void UpdatePlayerMail(Mail* m);
        void SavePlayerGold();
        ...
        */
        ...
        uint32 GetAtLoginFlag() const { return m_atLoginFlags; }
