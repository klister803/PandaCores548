...
struct GameObjectTemplate
{
    ...
    union                                                   // different GO types have different data field
    {
        ...
        struct
        {
            uint32 intactNumHits;                           // 0 Unused, int, Min value: -2147483648, Max value: 2147483647, Default value: 0
            uint32 creditProxyCreature;                     // 1 Credit Proxy Creature, References: Creature, NoValue = 0
            uint32 state1Name;                              // 2 Health Rec, References: DestructibleHitpoint, NoValue = 0
            uint32 intactEvent;                             // 3 Intact Event, References: GameEvents, NoValue = 0
            uint32 damagedDisplayId;                        // 4 PVP Enabling, enum { false, true, }; Default: false
            uint32 damagedNumHits;                          // 5 Interior Visible, enum { false, true, }; Default: false
            uint32 empty3;                                  // 6 Interior Light, enum { false, true, }; Default: false
            uint32 empty4;                                  // 7 Unused, int, Min value: -2147483648, Max value: 2147483647, Default value: 0
            uint32 empty5;                                  // 8 Unused, int, Min value: -2147483648, Max value: 2147483647, Default value: 0
            uint32 damagedEvent;                            // 9 Damaged Event, References: GameEvents, NoValue = 0
            uint32 destroyedDisplayId;                      // 10 Unused, int, Min value: -2147483648, Max value: 2147483647, Default value: 0
            uint32 empty7;                                  // 11 Unused, int, Min value: -2147483648, Max value: 2147483647, Default value: 0
            uint32 empty8;                                  // 12 Unused, int, Min value: -2147483648, Max value: 2147483647, Default value: 0
            uint32 empty9;                                  // 13 Unused, int, Min value: -2147483648, Max value: 2147483647, Default value: 0
            uint32 destroyedEvent;                          // 14 Destroyed Event, References: GameEvents, NoValue = 0
            uint32 empty10;                                 // 15 Unused, int, Min value: -2147483648, Max value: 2147483647, Default value: 0
            uint32 debuildingTimeSecs;                      // 16 Rebuilding: Time (secs), int, Min value: 0, Max value: 65535, Default value: 0
            uint32 empty11;                                 // 17 Unused, int, Min value: -2147483648, Max value: 2147483647, Default value: 0
            uint32 destructibleData;                        // 18 Destructible Model Rec, References: DestructibleModelData, NoValue = 0
            uint32 rebuildingEvent;                         // 19 Rebuilding: Event, References: GameEvents, NoValue = 0
            uint32 empty12;                                 // 20 Unused, int, Min value: -2147483648, Max value: 2147483647, Default value: 0
            uint32 empty13;                                 // 21 Unused, int, Min value: -2147483648, Max value: 2147483647, Default value: 0
