...
enum NPCFlags
{
    ...
    UNIT_NPC_FLAG_MAILBOX               = 0x04000000,       // NPC will act like a mailbox (opens mailbox with right-click)
...
class Unit : public WorldObject
{
    public:
        ...
        Powers getPowerType() const { return Powers(GetByteValue(UNIT_FIELD_DISPLAY_POWER, 3)); }
