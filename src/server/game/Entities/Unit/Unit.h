...
class Unit : public WorldObject
{
    public:
        ...
        uint32 CountPctFromMaxMana(int32 pct) const { return CalculatePct(GetPower(POWER_MANA), pct); }
        uint32 CountPctFromCurMana(int32 pct) const { return CalculatePct(GetMaxPower(POWER_MANA), pct); }
