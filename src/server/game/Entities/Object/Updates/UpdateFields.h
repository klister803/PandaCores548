...
enum EUnitFields
{
    ...
    UNIT_SUMMONED_BY_HOME_REALM                      = OBJECT_END + 0x10,
    UNIT_CHANNEL_SPELL                               = OBJECT_END + 0x11,
    ...
    UNIT_FIELD_RANGED_ATTACK_POWER                   = OBJECT_END + 0x76,
...
enum EPlayerFields
{
    ...
    PLAYER_QUEST_LOG_150_5                           = UNIT_END + 0x2F8,
    ...
    PLAYER__FIELD_KNOWN_TITLES2                      = UNIT_END + 0x3D7,
    PLAYER__FIELD_KNOWN_TITLES3                      = UNIT_END + 0x3D9,
    ...
    PLAYER_SKILL_MAX_RANK_0                          = UNIT_END + 0x49D,
    PLAYER_SKILL_MODIFIER_0                          = UNIT_END + 0x4DD,
...
enum EAreaTriggerFields
{
    ...
    AREATRIGGER_SPELLID                              = OBJECT_END + 0x2,
    AREATRIGGER_SPELLVISUALID                        = OBJECT_END + 0x3,
    AREATRIGGER_DURATION                             = OBJECT_END + 0x4,
