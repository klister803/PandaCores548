...
enum SpellCastResult
{
    ...
    SPELL_FAILED_TARGET_IN_PET_BATTLE           = 119,
    SPELL_FAILED_TARGET_IS_PLAYER               = 120,
    SPELL_FAILED_TARGET_IS_PLAYER_CONTROLLED    = 121,
    SPELL_FAILED_TARGET_NOT_DEAD                = 122,
    SPELL_FAILED_TARGET_NOT_IN_PARTY            = 123,
    SPELL_FAILED_TARGET_NOT_LOOTED              = 124,
    SPELL_FAILED_TARGET_NOT_PLAYER              = 125,
    SPELL_FAILED_TARGET_NO_POCKETS              = 126,
    SPELL_FAILED_TARGET_NO_WEAPONS              = 127,
    SPELL_FAILED_TARGET_NO_RANGED_WEAPONS       = 128,
    SPELL_FAILED_TARGET_UNSKINNABLE             = 129,
    SPELL_FAILED_THIRST_SATIATED                = 130,
    SPELL_FAILED_TOO_CLOSE                      = 131,
    SPELL_FAILED_TOO_MANY_OF_ITEM               = 132,
    SPELL_FAILED_TOTEM_CATEGORY                 = 133,
    SPELL_FAILED_TOTEMS                         = 134,
    SPELL_FAILED_TRY_AGAIN                      = 135,
    SPELL_FAILED_UNIT_NOT_BEHIND                = 136,
    SPELL_FAILED_UNIT_NOT_INFRONT               = 137,
    SPELL_FAILED_VISION_OBSCURED                = 138,
    SPELL_FAILED_WRONG_PET_FOOD                 = 139,
    SPELL_FAILED_NOT_WHILE_FATIGUED             = 140,
    SPELL_FAILED_TARGET_NOT_IN_INSTANCE         = 141,
    SPELL_FAILED_NOT_WHILE_TRADING              = 142,
    SPELL_FAILED_TARGET_NOT_IN_RAID             = 143,
    SPELL_FAILED_TARGET_FREEFORALL              = 144,
    SPELL_FAILED_NO_EDIBLE_CORPSES              = 145,
    SPELL_FAILED_ONLY_BATTLEGROUNDS             = 146,
    SPELL_FAILED_TARGET_NOT_GHOST               = 147,
    SPELL_FAILED_TRANSFORM_UNUSABLE             = 148,
    SPELL_FAILED_WRONG_WEATHER                  = 149,
    SPELL_FAILED_DAMAGE_IMMUNE                  = 150,
    SPELL_FAILED_PREVENTED_BY_MECHANIC          = 151,
    SPELL_FAILED_PLAY_TIME                      = 152,
    SPELL_FAILED_REPUTATION                     = 153,
    SPELL_FAILED_MIN_SKILL                      = 154,
    SPELL_FAILED_NOT_IN_RATED_BATTLEGROUND      = 155,
    SPELL_FAILED_NOT_ON_SHAPESHIFT              = 156,
    SPELL_FAILED_NOT_ON_STEALTHED               = 157,
    SPELL_FAILED_NOT_ON_DAMAGE_IMMUNE           = 158,
    SPELL_FAILED_NOT_ON_MOUNTED                 = 159,
    SPELL_FAILED_TOO_SHALLOW                    = 160,
    SPELL_FAILED_TARGET_NOT_IN_SANCTUARY        = 161,
    SPELL_FAILED_TARGET_IS_TRIVIAL              = 162,
    SPELL_FAILED_BM_OR_INVISGOD                 = 163,
    SPELL_FAILED_APPRENTICE_RIDING_REQUIREMENT  = 164,
    SPELL_FAILED_JOURNEYMAN_RIDING_REQUIREMENT  = 165,
    SPELL_FAILED_EXPERT_RIDING_REQUIREMENT      = 166,
    SPELL_FAILED_ARTISAN_RIDING_REQUIREMENT     = 167,
    SPELL_FAILED_MASTER_RIDING_REQUIREMENT      = 168,
    SPELL_FAILED_COLD_RIDING_REQUIREMENT        = 169,
    SPELL_FAILED_FLIGHT_MASTER_RIDING_REQUIREMENT = 170,
    SPELL_FAILED_NOT_IDLE                       = 171,
    SPELL_FAILED_NOT_INACTIVE                   = 172,
    SPELL_FAILED_PARTIAL_PLAYTIME               = 173,
    SPELL_FAILED_NO_PLAYTIME                    = 174,
    SPELL_FAILED_NOT_IN_BATTLEGROUND            = 175,
    SPELL_FAILED_NOT_IN_RAID_INSTANCE           = 176,
    SPELL_FAILED_ONLY_IN_ARENA                  = 177,
    SPELL_FAILED_TARGET_LOCKED_TO_RAID_INSTANCE = 178,
    SPELL_FAILED_ON_USE_ENCHANT                 = 179,
    SPELL_FAILED_NOT_ON_GROUND                  = 180,
    SPELL_FAILED_CUSTOM_ERROR                   = 181,
    SPELL_FAILED_CANT_DO_THAT_RIGHT_NOW         = 182,
    SPELL_FAILED_TOO_MANY_SOCKETS               = 183,
    SPELL_FAILED_INVALID_GLYPH                  = 184,
    SPELL_FAILED_UNIQUE_GLYPH                   = 185,
    SPELL_FAILED_GLYPH_SOCKET_LOCKED            = 186,
    SPELL_FAILED_NO_VALID_TARGETS               = 187,
    SPELL_FAILED_ITEM_AT_MAX_CHARGES            = 188,
    SPELL_FAILED_NOT_IN_BARBERSHOP              = 189,
    SPELL_FAILED_FISHING_TOO_LOW                = 190,
    SPELL_FAILED_ITEM_ENCHANT_TRADE_WINDOW      = 191,
    SPELL_FAILED_SUMMON_PENDING                 = 192,
    SPELL_FAILED_MAX_SOCKETS                    = 193,
    SPELL_FAILED_PET_CAN_RENAME                 = 194,
    SPELL_FAILED_TARGET_CANNOT_BE_RESURRECTED   = 195,
    SPELL_FAILED_NO_ACTIONS                     = 196,
    SPELL_FAILED_CURRENCY_WEIGHT_MISMATCH       = 197,
    SPELL_FAILED_WEIGHT_NOT_ENOUGH              = 198,
    SPELL_FAILED_WEIGHT_TOO_MUCH                = 199,
    SPELL_FAILED_NO_VACANT_SEAT                 = 200,
    SPELL_FAILED_NO_LIQUID                      = 201,
    SPELL_FAILED_ONLY_NOT_SWIMMING              = 202,
    SPELL_FAILED_BY_NOT_MOVING                  = 203,
    SPELL_FAILED_IN_COMBAT_RES_LIMIT_REACHED    = 204,
    SPELL_FAILED_NOT_IN_ARENA                   = 205,
    SPELL_FAILED_TARGET_NOT_GROUNDED            = 206,
    SPELL_FAILED_EXCEEDED_WEEKLY_USAGE          = 207,
    SPELL_FAILED_NOT_IN_LFG_DUNGEON             = 208,
    SPELL_FAILED_BAD_TARGET_FILTER              = 209,
    SPELL_FAILED_NOT_ENOUGH_TARGETS             = 210,
    SPELL_FAILED_NO_SPEC                        = 211,
    SPELL_FAILED_CANT_ADD_BATTLE_PET            = 212,
