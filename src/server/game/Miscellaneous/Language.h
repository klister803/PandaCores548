...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_ARENA_CLOSESEASON_TEAM_WIN     = 12002,
    LANG_ARENA_CLOSESEASON_PLAYER_WIN   = 12003,
    LANG_ARENA_CLOSESEASON_END_1_TYPE   = 12004,
    LANG_ARENA_CLOSESEASON_BEG_2_TYPE   = 12005,
    LANG_ARENA_CLOSESEASON_END_2_TYPE   = 12006,
    LANG_ARENA_CLOSESEASON_BEG_3_TYPE   = 12007,
    LANG_ARENA_CLOSESEASON_END_3_TYPE   = 12008,
    ...
    LANG_COMMAND_TARGET_NON_EFFECT_AURADETAIL = 13004,

    // Word filter
    LANG_WORD_FILTER_FOUND_BAD_WORD_IN_CHAT = 21000,
    LANG_WORD_FILTER_FOUND_BAD_WORD_IN_MAIL = 21001,

    LANG_CLIENT_VERSION_MISMATCH_MESSAGE        = 21002,
    LANG_CLIENT_VERSION_MISMATCH_MESSAGE_NOTIFY = 21003
