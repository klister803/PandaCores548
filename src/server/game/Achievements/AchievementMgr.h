...
class AchievementMgr
{
    public:
        ...
        void UpdateAchievementCriteria(AchievementCriteriaTypes type, uint32 miscValue1 = 0, uint32 miscValue2 = 0, constUnitPtr unit = nullptr, PlayerPtr referencePlayer = nullptr);
