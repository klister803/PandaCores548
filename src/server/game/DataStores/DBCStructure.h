...
struct AchievementEntry
{
    ...
    //char* Description;                                    // 5
    uint32    CategoryID;                                   // 6
    uint32    RewardPoints;                                 // 7 reward points
    //uint32 OrderInCategory;                               // 8
    uint32    Flags;                                        // 9
    //uint32    IconID;                                     // 10 icon (from SpellIcon.dbc)
    //char* Reward;                                         // 11
    uint32 Amount;                                          // 12 - need this count of completed criterias (own or referenced achievement criterias)
...
struct CriteriaEntry
{
    ...
    uint32  Asset;                                         // 2 m_asset
    uint32  StartEvent;                                    // 3 m_start_event
    uint32  StartAsset;                                    // 4 m_start_asset
    uint32  StartTimer;                                    // 5 m_time
    uint32  FailEvent;                                     // 6 m_fail_event
    uint32  FailAsset;                                     // 7 m_fail_asset
    uint32  ModifyTree;                                    // 8 m_modifier_tree_id
    uint32  Flags;                                         // 9 m_flags
    uint32  EligibilityWorldStateID;                       // 10 m_eligibility_world_state_ID
    uint32  EligibilityWorldStateValue;                    // 11 m_eligibility_world_state_value
};
...
struct ModifierTreeEntry // additional Condition
{
    ...
    uint32  Type;                                          // 1 m_type
    uint32  Asset;                                         // 2 m_asset
    uint32  SecondaryAsset;                                // 3 m_secondaryAsset
    uint32  Operator;                                      // 4 m_operator
    uint32  Amount;                                        // 5 m_amount
...
struct CharStartOutfitEntry
{
    ...
    int32 ItemId[MAX_OUTFIT_ITEMS];                         // 2-26
    int32 ItemDisplayId[MAX_OUTFIT_ITEMS];                  // 27-51 not required at server side m_DisplayItemID
    //int32 m_InventoryType[MAX_OUTFIT_ITEMS];              // 52-76 not required at server side m_InventoryType 
    //uint32 m_petDisplayID;                                // 38, unique values (index-like with gaps ordered in other way as ids)
    //uint32 m_petFamilyID;                                 // 39
    //uint32 Unknown3;                                      // 40
    //uint32 Unknown4;                                      // 41
    //uint32 Unknown5;                                      // 42
};
...
struct ChrClassesEntry
{
    ...
    //uint32 m_defaultSpec                                  // 14       m_defaultSpec
    //uint32 m_createScreenFileDataID                       // 15       m_createScreenFileDataID
    //uint32 m_selectScreenFileDataID                       // 16       m_selectScreenFileDataID
    //uint32 m_lowResScreenFileDataID                       // 17       m_lowResScreenFileDataID
    //uint32 m_iconFileDataID                               // 18       m_iconFileDataID
};
...
struct SpellEffectEntry
{
    ...
    //float                                                 // 24        m_effectPos_facing 5.0.5
    ...
    //uint32  Unk0                                          // 29        m_effectAttributes 4.2.0 only 0 or 1
};
