...
const char LFGDungeonEntryfmt[]="nxiiiiiiixxxixxixixxxxx";
...
const char MapEntryfmt[]="nxixxsixxixiffxiixi";
...
const char SpellEffectEntryfmt[]="nxifiiiffiiiiiifiifiiiixxiiiix";
const char SpellEffectScalingEntryfmt[]="nfffi";
