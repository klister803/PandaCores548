...
const char Criteriafmt[]="niiiiiiiixxx";
...
const char AreaTableEntryfmt[]="iiinixxxxxxxisiiiiifxxixxxxxii";
...
const char LFGDungeonEntryfmt[]="nsiiiiiiiiiixixixiiiiiiiiixxx";
...
const char Scenariofmt[]="nxi";
const char ScenarioStepfmt[]="niiixxi";
...
const char SpellMiscEntryfmt[]="nixiiiiiiiiiiiiiiiiifiiiii";
