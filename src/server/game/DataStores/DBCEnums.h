...
enum CriteriaAdditionalCondition
{
    ...
    CRITERIA_ADDITIONAL_CONDITION_UPDATE_NEXT_VERSION         = 33, // NYI
    ...
    CRITERIA_ADDITIONAL_CONDITION_UNK69                       = 69, // NYI
    ...
    CRITERIA_ADDITIONAL_CONDITION_UNK74                       = 74, // NYI
    ...
    CRITERIA_ADDITIONAL_CONDITION_UNK80                       = 80, // NYI
    ...
    CRITERIA_ADDITIONAL_CONDITION_BATTLE_PET_ID               = 84,
    CRITERIA_ADDITIONAL_CONDITION_UNK86                       = 86, // NYI
    CRITERIA_ADDITIONAL_CONDITION_UNK87                       = 87, // NYI
    CRITERIA_ADDITIONAL_CONDITION_UNK88                       = 88, // NYI
    ...
    CRITERIA_ADDITIONAL_CONDITION_UNK99                       = 99, // NYI
    CRITERIA_ADDITIONAL_CONDITION_UNK112                      = 112, // NYI
    CRITERIA_ADDITIONAL_CONDITION_CURRENCY                    = 121, // Currency
