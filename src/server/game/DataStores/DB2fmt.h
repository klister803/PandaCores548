...
const char BattlePetAbilityEntryfmt[]="nixixxxx";
const char BattlePetAbilityEffectEntryfmt[]="nixxiiiiiiix";
const char BattlePetEffectPropertiesEntryfmt[]="nxsssssxxxxxxx";
