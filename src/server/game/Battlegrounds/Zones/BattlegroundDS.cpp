...
void BattlegroundDS::HandleKillPlayer(Player* player, Player* killer)
{
    ...
    if (!killer)
    {
        TC_LOG_ERROR("bg", "BattlegroundDS: Killer player not found");
        return;
    }
...
bool BattlegroundDS::SetupBattleground()
{
    ...
    // buffs
        || !AddObject(BG_DS_OBJECT_BUFF_1, BG_DS_OBJECT_TYPE_BUFF_1, 1291.7f, 835.3154f, 3.1597f, 4.64562f, 0, 0, 0.730314f, -0.683111f, 120)
        || !AddObject(BG_DS_OBJECT_BUFF_2, BG_DS_OBJECT_TYPE_BUFF_2, 1291.7f, 746.5369f, 3.1599f, 1.55194f, 0, 0, 0.700409f, 0.713742f, 120)
    // knockback creatures
    ...
    {
        TC_LOG_ERROR("sql", "BatteGroundDS: Failed to spawn some object!");
        return false;
    }
