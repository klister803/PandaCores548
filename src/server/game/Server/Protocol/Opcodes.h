...
enum Opcodes
{
    ...
    CMSG_CALENDAR_CONTEXT_EVENT_SIGNUP                = 0x000,
    ...
    CMSG_CLEAR_CHANNEL_WATCH                          = 0xC71,
    ...
    CMSG_GAMESPEED_SET                                = 0x000,
    CMSG_GAMETIME_SET                                 = 0x000,
    CMSG_GETDEATHBINDZONE                             = 0x000,
    ...
    CMSG_GM_SET_SECURITY_GROUP                        = 0x000,
