...
enum Opcodes
{
    ...
    CMSG_SET_EVERYONE_IS_ASSISTANT                    = 0x0F1,
    ...
    CMSG_START_QUEST                                  = 0x000,
    CMSG_STOP_DANCE                                   = 0xCF6,  // 5.0.5 16048
    CMSG_STORE_LOOT_IN_SLOT                           = 0x000,
    ...
    CMSG_TRIGGER_CINEMATIC_CHEAT                      = 0x000,
    ...
    MSG_GM_BIND_OTHER                                 = 0x000,
    MSG_GM_SHOWLABEL                                  = 0x000,
    MSG_GM_SUMMON                                     = 0x000,
    ...
    MSG_MOVE_FEATHER_FALL                             = 0x000,
    MSG_MOVE_GRAVITY_CHNG                             = 0x000,
    MSG_MOVE_HEARTBEAT                                = 0,
    MSG_MOVE_HOVER                                    = 0x000,
    MSG_MOVE_JUMP                                     = 0,
    MSG_MOVE_SET_ALL_SPEED_CHEAT                      = 0x000,
    MSG_MOVE_SET_COLLISION_HEIGHT                     = 0x000,
    MSG_MOVE_SET_FACING                               = 0,
    MSG_MOVE_SET_FLIGHT_SPEED_CHEAT                   = 0x000,
    MSG_MOVE_SET_PITCH                                = 0,
    MSG_MOVE_SET_RAW_POSITION_ACK                     = 0x000,
    MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT                 = 0x000,
    MSG_MOVE_SET_RUN_MODE                             = 0,
    MSG_MOVE_SET_RUN_SPEED_CHEAT                      = 0x000,
    MSG_MOVE_SET_SWIM_BACK_SPEED_CHEAT                = 0x000,
    MSG_MOVE_SET_SWIM_SPEED_CHEAT                     = 0x000,
    MSG_MOVE_SET_TURN_RATE_CHEAT                      = 0x000,
    MSG_MOVE_SET_WALK_MODE                            = 0,
    MSG_MOVE_SET_WALK_SPEED_CHEAT                     = 0x000,
    ...
    MSG_MOVE_TOGGLE_FALL_LOGGING                      = 0x000,
    MSG_MOVE_TOGGLE_LOGGING                           = 0x000,
