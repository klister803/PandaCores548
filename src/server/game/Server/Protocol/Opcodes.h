...
enum Opcodes
{
    ...
    CMSG_MOVE_SET_VEHICLE_REC_ID_ACK                  = 0x000,  // not found in 4.3.4
    ...
    CMSG_PLAYER_DIFFICULTY_CHANGE                     = 0x000,
    ...
    CMSG_QUESTGIVER_QUEST_AUTOLAUNCH                  = 0x000,
    ...
    CMSG_QUESTLOG_SWAP_QUEST                          = 0x000,
    ...
    CMSG_SAVE_PLAYER                                  = 0x000,
    CMSG_SEARCH_LFG_JOIN                              = 0x000,
    CMSG_SEARCH_LFG_LEAVE                             = 0x000,
    ...
    CMSG_SERVERTIME                                   = 0x000,
    CMSG_SETDEATHBINDPOINT                            = 0x000,
    ...
    SMSG_FORCEACTIONSHOW                              = 0x000,
    SMSG_FORCED_DEATH_UPDATE                          = 0xC13,  // 5.0.5 16048
    SMSG_FORCE_DISPLAY_UPDATE                         = 0x000,
    ...
    SMSG_LFG_OPEN_FROM_GOSSIP                         = 0x000,
    ...
    SMSG_LFG_UPDATE_LIST                              = 0x000,
    SMSG_LFG_UPDATE_PARTY                             = 0x000,
    SMSG_LFG_UPDATE_PLAYER                            = 0x000,
    ...
    SMSG_SET_PLAYER_DECLINED_NAMES_RESULT             = 0,      // Only in RUS Client version
