...
enum Opcodes
{
    ...
    SMSG_CHECK_FOR_BOTS                               = 0x000,
    SMSG_CLEAR_BOSS_EMOTES                            = 0xB87,  // 5.0.5 16048
    SMSG_CLEAR_COOLDOWN                               = 0x000,
    ...
    SMSG_COMBAT_LOG_MULTIPLE                          = 0x000,
    ...
    SMSG_DAMAGE_DONE_OBSOLETE                         = 0x000,
    ...
    SMSG_INSTANCE_DIFFICULTY                          = 0x000,
    ...
    SMSG_JOINED_BATTLEGROUND_QUEUE                    = 0x000,
    SMSG_KICK_REASON                                  = 0x000,
    ...
    SMSG_MEETINGSTONE_MEMBER_ADDED                    = 0x000,
    SMSG_MEETINGSTONE_SETQUEUE                        = 0x000,
    ...
    SMSG_RAID_INSTANCE_INFO                           = 0,      // Deprecated ?
