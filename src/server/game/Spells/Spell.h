...
enum SpellCastFlags
{
    ...
    CAST_FLAG_IGNORE_AOE_VISUAL  = 0x00000004,
    CAST_FLAG_PROJECTILE         = 0x00000008,
    CAST_FLAG_POWER_LEFT_SELF    = 0x00000010,
    CAST_FLAG_ADJUST_MISSILE     = 0x00000020,
    CAST_FLAG_VISUAL_CHAIN       = 0x00000040,
    CAST_FLAG_RUNE_LIST          = 0x00000080,
    CAST_FLAG_IMMUNITY           = 0x00000100,
    CAST_FLAG_HEAL_PREDICTION    = 0x00000200,
};
