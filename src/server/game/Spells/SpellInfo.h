...
enum SpellCustomAttributes
{
    ...
    SPELL_ATTR0_CU_REMOVE_AFTER_DELAY            = 0x00100000,
    SPELL_ATTR0_CU_HAVE_STABLE_FLYTIME           = 0x00200000,
    SPELL_ATTR0_CU_NEED_BE_SAVED_IN_DB           = 0x00400000,
    SPELL_ATTR0_CU_PROC_ONLY_ON_CAST             = 0x00800000,
    SPELL_ATTR0_CU_CANT_CAST_ROOTED              = 0x01000000,
    SPELL_ATTR0_CU_DOESENT_INTERRUPT_CHANNELING  = 0x02000000,
    SPELL_ATTR0_CU_CANT_STACK_WITH_ITSELF        = 0x04000000,
    SPELL_ATTR0_CU_CASTED_BY_AREATRIGGER         = 0x08000000,
    SPELL_ATTR0_CU_CANT_BE_SAVED_IN_DB           = 0x10000000,
...
public:
    ...
    SpellCastResult CheckShapeshift(Unit const* _caster) const;
