...
class AuraEffect
{
    ...
    friend void Aura::_InitEffect(uint8 effMask, Unit* caster, float *baseAmount);
    ...
    public:
        ...
        uint32 GetTotalTicks() const { return m_amplitude ? (GetBase()->GetMaxDuration() / m_amplitude) : 1;}
