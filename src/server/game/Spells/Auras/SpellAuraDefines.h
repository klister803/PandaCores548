...
enum AuraType
{
    ...
    SPELL_AURA_63                                           = 63,  // old SPELL_AURA_PERIODIC_MANA_FUNNEL, unused now
    ...
    SPELL_AURA_90                                           = 90,  // old SPELL_AURA_MOD_RESIST_CHANCE, unused now
    ...
    SPELL_AURA_119                                          = 119,  // old SPELL_AURA_SHARE_PET_TRACKING, unused now
    ...
    SPELL_AURA_153                                          = 153,  // old SPELL_AURA_SPLIT_DAMAGE_FLAT, unused now
    ...
    SPELL_AURA_160                                          = 160,  // old SPELL_AURA_MOD_AOE_AVOIDANCE, unused now
    SPELL_AURA_MOD_HEALTH_REGEN_IN_COMBAT                   = 161,
    SPELL_AURA_POWER_BURN                                   = 162,
    SPELL_AURA_MOD_CRIT_DAMAGE_BONUS                        = 163,
    SPELL_AURA_164                                          = 164, // unk use in 110317
    SPELL_AURA_MELEE_ATTACK_POWER_ATTACKER_BONUS            = 165,
    SPELL_AURA_MOD_ATTACK_POWER_PCT                         = 166,
    SPELL_AURA_MOD_RANGED_ATTACK_POWER_PCT                  = 167,
    SPELL_AURA_MOD_DAMAGE_DONE_VERSUS                       = 168,
    SPELL_AURA_169                                          = 169, // old SPELL_AURA_MOD_CRIT_PERCENT_VERSUS, unused now
    SPELL_AURA_DETECT_AMORE                                 = 170,
    SPELL_AURA_MOD_SPEED_NOT_STACK                          = 171,
    SPELL_AURA_MOD_MOUNTED_SPEED_NOT_STACK                  = 172,
    SPELL_AURA_173                                          = 173,  // old SPELL_AURA_ALLOW_CHAMPION_SPELLS, unused now
    ...
    SPELL_AURA_178                                          = 178, // old SPELL_AURA_MOD_DEBUFF_RESISTANCE, unused now
    SPELL_AURA_MOD_ATTACKER_SPELL_CRIT_CHANCE               = 179,
    SPELL_AURA_MOD_FLAT_SPELL_DAMAGE_VERSUS                 = 180,
    SPELL_AURA_181                                          = 181,  // old SPELL_AURA_MOD_FLAT_SPELL_CRIT_DAMAGE_VERSUS, unused now
    ...
    SPELL_AURA_198                                          = 198, // old SPELL_AURA_MOD_ALL_WEAPON_SKILLS, unused now
    SPELL_AURA_199                                          = 199, // old SPELL_AURA_MOD_INCREASES_SPELL_PCT_TO_HIT, unused now
    ...
    SPELL_AURA_212                                          = 212, // old SPELL_AURA_MOD_RANGED_ATTACK_POWER_OF_STAT_PERCENT, unused now
    ...
    SPELL_AURA_MOD_INCREASE_HEALTH_3                        = 250,
    ...
    SPELL_AURA_289                                          = 289, // unk use in 82890
    ...
    SPELL_AURA_MOD_ITEM_LOOT                                = 350,  // NYI
    ...
    SPELL_AURA_MOD_SPELL_COOLDOWN_BY_MELEE_HASTE            = 416,  // SPELL_AURA_MOD_SPELL_COOLDOWN_BY_MELEE_HASTE
    SPELL_AURA_MOD_SPELL_GDC_BY_MELEE_HASTE                 = 417,  // SPELL_AURA_MOD_SPELL_GDC_BY_MELEE_HASTE
    ...
    SPELL_AURA_427                                          = 427,  // Entering Battleground
    ...
    SPELL_AURA_436                                          = 436,  // 1 test spell
    SPELL_AURA_437                                          = 437,
    TOTAL_AURAS                                             = 438,
};
