...
enum AuraType
{
    ...
    SPELL_AURA_LOOT_BONUS                                   = 394,  // 5.0.5 unk aura
    SPELL_AURA_395                                          = 395,  // 5.0.5 unk aura
    SPELL_AURA_396                                          = 396,  // some power-dependent auras and casts
    SPELL_AURA_397                                          = 397,  // 0 auras
    SPELL_AURA_398                                          = 398,  // Netherstorm Flag
    SPELL_AURA_399                                          = 399,  //0 auras
    SPELL_AURA_SKILL_2                                      = 400,
    SPELL_AURA_401                                          = 401,  // cart capture points
    ...
    SPELL_AURA_428                                          = 428,
    SPELL_AURA_PET_DAMAGE_DONE                              = 429,
    SPELL_AURA_430                                          = 430,
