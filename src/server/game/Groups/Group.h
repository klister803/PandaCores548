...
enum GroupUpdateFlags
{
    ...
    GROUP_UPDATE_FLAG_UNK               = 0x00000002,
    ...
    GROUP_UPDATE_FLAG_CUR_POWER         = 0x00000020,       // uint16
    GROUP_UPDATE_FLAG_MAX_POWER         = 0x00000040,       // uint16
    GROUP_UPDATE_FLAG_LEVEL             = 0x00000080,       // uint16
    GROUP_UPDATE_FLAG_ZONE              = 0x00000100,       // uint16
    GROUP_UPDATE_FLAG_POSITION          = 0x00000200,       // uint16, uint16
    ...
    GROUP_UPDATE_FLAG_VEHICLE_SEAT      = 0x00100000,       // uint8, uint64, if (uint32 != 0) { uint32, if (uint16 & 0x40) { uint32, uint32, uint32 } }
    GROUP_UPDATE_FLAG_UNKNOWN_1         = 0x00200000,       // uint32
    GROUP_UPDATE_FLAG_UNKNOWN_2         = 0x00400000,       // uint32, uint32, string
    GROUP_UPDATE_PET                    = 0x000FF800,       // all pet flags
    GROUP_UPDATE_FULL                   = 0x000FFFFE,       // all known flags
};
