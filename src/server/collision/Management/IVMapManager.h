    ...
    class IVMapManager
    {
        ...
        public:
            ...
            */
            ...
            virtual bool GetLiquidLevel(uint32 pMapId, float x, float y, float z, uint8 ReqLiquidType, float &level, float &floor, uint32 &type, uint32 &flags, int32 &adtId, int32 &rootId, int32 &groupId) const=0;
    };
