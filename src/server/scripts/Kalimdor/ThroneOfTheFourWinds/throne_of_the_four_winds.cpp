	...
	struct npc_slipstream_raidAI : public ScriptedAI
	{
		...
		void MoveInLineOfSight(Unit* who)
		{
			...
			if(who->GetExactDist(me) <= 5.f)
			{
				...
				who->UpdatePosition(SlipstreamPositions[SlipstreamPosition].GetPositionX(),SlipstreamPositions[SlipstreamPosition].GetPositionY(),SlipstreamPositions[SlipstreamPosition].GetPositionZ(),0.0f,false);
