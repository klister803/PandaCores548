...
public:
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables...");
        LoadLootTables();
    ...
    static bool HandleReloadAllQuestCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        TC_LOG_INFO("server", "Re-Loading Quests Relations...");
    ...
    static bool HandleReloadAllScriptsCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        TC_LOG_INFO("server", "Re-Loading Scripts...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading config settings...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Access Requirement definitions...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Additional Achievement Criteria Data...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Achievement Reward Data...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Tavern Area Triggers...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading AreaTrigger teleport definitions...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Autobroadcasts...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading creature award reputation definitions...");
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            TC_LOG_INFO("server", "Reloading creature template entry %u", entry);
            ...
            cInfo->KillCredit[0]      = fields[index++].GetUInt32();
            cInfo->KillCredit[1]      = fields[index++].GetUInt32();
            ...
            cInfo->questItems[0]      = fields[index++].GetUInt32();
            cInfo->questItems[1]      = fields[index++].GetUInt32();
            cInfo->questItems[2]      = fields[index++].GetUInt32();
            cInfo->questItems[3]      = fields[index++].GetUInt32();
            cInfo->questItems[4]      = fields[index++].GetUInt32();
    ...
    {
        TC_LOG_INFO("server", "Loading Quests Relations... (`creature_questrelation`)");
    ...
    {
        TC_LOG_INFO("server", "Loading Linked Respawns... (`creature_linked_respawn`)");
    ...
    {
        TC_LOG_INFO("server", "Loading Quests Relations... (`creature_involvedrelation`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading `gossip_menu` Table!");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading `gossip_menu_option` Table!");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading `guild_rewards` Table!");
    ...
    {
        TC_LOG_INFO("server", "Loading Quests Relations... (`gameobject_questrelation`)");
    ...
    {
        TC_LOG_INFO("server", "Loading Quests Relations... (`gameobject_involvedrelation`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Quest Area Triggers...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Quest Templates...");
        sObjectMgr->LoadQuests();
        handler->SendGlobalGMSysMessage("DB table `quest_template` (quest definitions) reloaded.");

        /// dependent also from `gameobject` but this table not reloaded anyway
        TC_LOG_INFO("server", "Re-Loading GameObjects for quests...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables... (`creature_loot_template`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables... (`disenchant_loot_template`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables... (`fishing_loot_template`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables... (`gameobject_loot_template`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables... (`item_loot_template`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables... (`milling_loot_template`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables... (`pickpocketing_loot_template`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables... (`prospecting_loot_template`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables... (`mail_loot_template`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables... (`reference_loot_template`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables... (`skinning_loot_template`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Loot Tables... (`spell_loot_template`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading trinity_string Table!");
    ...
    static bool HandleReloadWardenDataCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        TC_LOG_INFO("server", "Re-Loading warden_overrides Table!");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading `npc_trainer` Table!");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading `npc_vendor` Table!");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading `points_of_interest` Table!");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Quest POI ..." );
    ...
    {
        TC_LOG_INFO("server", "Re-Loading `npc_spellclick_spells` Table!");
    ...
    {
        TC_LOG_INFO("server", "Loading ReservedNames... (`reserved_name`)");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading `reputation_reward_rate` Table!" );
    ...
    {
        TC_LOG_INFO("server", "Re-Loading `reputation_spillover_template` Table!" );
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Skill Discovery Table...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Skill Extra Item Table...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Skill Fishing base level requirements...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading SpellArea Data...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Spell Required Data... ");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Spell Groups...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Spell Learn Spells...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Spell Linked Spells...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Spell Proc Event conditions...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Spell Proc conditions and data...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Spell Bonus Data...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Spell target coordinates...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Aggro Spells Definitions...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Spell Group Stack Rules...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Spell pet auras...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Page Texts...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Item Random Enchantments Table...");
    ...
    static bool HandleReloadGameObjectScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            TC_LOG_INFO("server", "Re-Loading Scripts from `gameobject_scripts`...");
    ...
    static bool HandleReloadEventScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            TC_LOG_INFO("server", "Re-Loading Scripts from `event_scripts`...");
    ...
    static bool HandleReloadWpScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            TC_LOG_INFO("server", "Re-Loading Scripts from `waypoint_scripts`...");
    ...
    {
        if (*args != 'a')
            TC_LOG_INFO("server", "Re-Loading Waypoints data from 'waypoints_data'");
    ...
    static bool HandleReloadQuestEndScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            TC_LOG_INFO("server", "Re-Loading Scripts from `quest_end_scripts`...");
    ...
    static bool HandleReloadQuestStartScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            TC_LOG_INFO("server", "Re-Loading Scripts from `quest_start_scripts`...");
    ...
    static bool HandleReloadSpellScriptsCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (*args != 'a')
            TC_LOG_INFO("server", "Re-Loading Scripts from `spell_scripts`...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Script strings from `db_script_string`...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Graveyard-zone links...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Game Tele coordinates...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading disables table...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Locales Achievement Reward Data...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading lfg dungeon rewards...");
        sLFGMgr->LoadRewards();
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Locales Creature ...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Locales Creature Texts...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Locales Gameobject ... ");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Locales Gossip Menu Option ... ");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Locales Item ... ");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Locales NPC Text ... ");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Locales Page Text ... ");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Locales Points Of Interest ... ");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Locales Quest ... ");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Player level dependent mail rewards...");
    ...
    static bool HandleReloadAuctionsCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        TC_LOG_INFO("server", "Re-Loading Auctions...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Conditions...");
        sConditionMgr->LoadConditions(true);
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Creature Texts...");
    ...
    {
        TC_LOG_INFO("server", "Re-Loading Smart Scripts...");
    ...
    {
        TC_LOG_INFO("server", "Reloading vehicle_accessory table...");
    ...
    {
        TC_LOG_INFO("server", "Reloading vehicle_template_accessory table...");
    ...
    {
        TC_LOG_INFO("server", "Reloading script_waypoint table...");
    ...
    {	
        TC_LOG_INFO("server", "Reloading phase_definitions table...");	
    ...
    {
        TC_LOG_INFO("server", "Updating Creature Area...");
        ...
        if (!result)
        {
            TC_LOG_INFO("server", "Updated 0 creature area.");
            return true;
        }
    ...
    {
        TC_LOG_INFO("server","Re-Loading Letter Analogs...");
    ...
    {
        TC_LOG_INFO("server","Re-Loading Bad Words...");
    ...
    {
        TC_LOG_INFO("server","Re-Loading Banned Addons...");
    ...
    {
        TC_LOG_INFO("server", "Reloading Anti spamm table...");
