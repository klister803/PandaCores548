...
EnumName<CreatureFlagsExtra> const flagsExtra[FLAGS_EXTRA_COUNT] =
{
    ...
    CREATE_NAMED_ENUM(CREATURE_FLAG_EXTRA_NO_DODGE),
...
public:
    ...
    static bool HandleNpcInfoCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        handler->PSendSysMessage(LANG_NPCINFO_CHAR,  target->GetDBTableGUIDLow(), target->GetGUIDLow(), faction, npcflags, npcflags2, Entry, displayid, nativeid);
