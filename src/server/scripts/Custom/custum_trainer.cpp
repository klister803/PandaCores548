...
class custum_trainer : public CreatureScript
{
    public:
        ...
        bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
        {
            ...
            {
                case 999999:
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Изучить дополнительные заклинания", GOSSIP_SENDER_MAIN, 1);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Забыть дополнительные заклинания", GOSSIP_SENDER_MAIN, 4);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Меню телепортации", GOSSIP_SENDER_MAIN, 2); 
                    //player->ADD_GOSSIP_ITEM(GOSSIP_ICON_MONEY_BAG, "Полезные предметы за очки чести", GOSSIP_SENDER_MAIN, 3); 
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_VENDOR, "Меню Доната (Заклинания за Эфириальные Монеты)", GOSSIP_SENDER_MAIN, 5); 
                    player->SEND_GOSSIP_MENU(51000, creature->GetGUID());
                    break;
                case 1: // First menu (SPELLS) and it's cases
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Пища", GOSSIP_SENDER_MAIN, 45548);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Питьё", GOSSIP_SENDER_MAIN, 43183);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Водное дыхание", GOSSIP_SENDER_MAIN, 1446);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Парашют", GOSSIP_SENDER_MAIN, 45472);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Взлом замка", GOSSIP_SENDER_MAIN, 1804);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Облик стремительной птицы", GOSSIP_SENDER_MAIN, 40123); 
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Вызов камня встреч", GOSSIP_SENDER_MAIN, 23598); 
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Дефибрилляция", GOSSIP_SENDER_MAIN, 54732); 
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Портал в Даларан - 300 gold", GOSSIP_SENDER_MAIN, 73324); 
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Портал в Шаттрат -300 gold", GOSSIP_SENDER_MAIN, 57676); 
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_TRAINER, "Портал в Чёрный Храм -300 gold", GOSSIP_SENDER_MAIN, 41234); 
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Назад", GOSSIP_SENDER_MAIN, 11);
                    player->SEND_GOSSIP_MENU(51000, creature->GetGUID());
                    break;
                ...
                case 2: //Second menu (TELEPORT_MAIN) and it's cases
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Города", GOSSIP_SENDER_MAIN, 21); 
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Данжи", GOSSIP_SENDER_MAIN, 22); 
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Рэйдовые подземелья", GOSSIP_SENDER_MAIN, 23); 
					player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "PvP Зоны", GOSSIP_SENDER_MAIN, 24); 
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Просто интересные места", GOSSIP_SENDER_MAIN, 25); 
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Назад", GOSSIP_SENDER_MAIN, 999999);
                    player->SEND_GOSSIP_MENU(51000, creature->GetGUID());
                    break;
                case 21: //Second menu (TELEPORT_CITIES) and it's cases
                    if ( player->GetTeam() == ALLIANCE ) 
                    {
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт в Штормград", GOSSIP_SENDER_MAIN, 211); 
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт в Стальгорн", GOSSIP_SENDER_MAIN, 212); 
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт в Дарнас", GOSSIP_SENDER_MAIN, 213); 
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт в Экзодар", GOSSIP_SENDER_MAIN, 214); 
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт на Вневременный остров", GOSSIP_SENDER_MAIN, 2113); 
                    }
                    else
                    {
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт в Оргриммар", GOSSIP_SENDER_MAIN, 215);
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт в Громовой Утес", GOSSIP_SENDER_MAIN, 216);
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт в Подгород", GOSSIP_SENDER_MAIN, 217);
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт в Луносвет", GOSSIP_SENDER_MAIN, 218);
                        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт на Вневременный остров", GOSSIP_SENDER_MAIN, 2114); 
                    }
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт в Кабестан", GOSSIP_SENDER_MAIN, 219);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт в Круговзор", GOSSIP_SENDER_MAIN, 2110);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт в Прибамбасск", GOSSIP_SENDER_MAIN, 2111);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Телепорт в Пиратскуя Бухту", GOSSIP_SENDER_MAIN, 2112);
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Назад", GOSSIP_SENDER_MAIN, 2); 
                    player->SEND_GOSSIP_MENU(51000, creature->GetGUID());
                    break;
                case 211: //Stormwind
                    player->CLOSE_GOSSIP_MENU();
                ...
                case 221: //Second menu (TELEPORT_DUNGEON_INSTANCES_CLASSIC)
                    ...
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Назад", GOSSIP_SENDER_MAIN, 22); 
                    player->SEND_GOSSIP_MENU(51000, creature->GetGUID());
                    break;
                case 2211: //Deadmines
                    player->CLOSE_GOSSIP_MENU();
                ...
                case 231: //Third menu (TELEPORT_RAID_INSTANCES_CLASSIC) and it's cases
                    ...
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Назад", GOSSIP_SENDER_MAIN, 23); 
                    player->SEND_GOSSIP_MENU(51000, creature->GetGUID());
                    break;
                ...
                case 251: //Easter Eggs
                    ...
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Назад", GOSSIP_SENDER_MAIN, 25); 
                    player->SEND_GOSSIP_MENU(51000, creature->GetGUID());
                    break;
                ...
                case 51: //Donation illusion submenu
                    ...
                    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_INTERACT_1, "Назад", GOSSIP_SENDER_MAIN, 5);
                    player->SEND_GOSSIP_MENU(51000, creature->GetGUID());
                    break;
