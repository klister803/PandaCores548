                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_OUTRO_3:
                            ...
                            if(instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
                            {
                                ...
                                me->SummonGameObject(GO_STAIRS_SKYBREAKER, 5215.89f, 1626.08f, 796.456f, -0.698132f, 0, 0, 0.0f, 1.0f, 1*DAY);
                                me->SummonGameObject(GO_STAIRS_SKYBREAKER, 5228.79f, 1641.93f, 784.305f, 5.61716f, 0, 0, 0.326893f, -0.945061f, 1*DAY);
                            } else
                            {
                                DoScriptText(SAY_SYLVANA_FINAL_1, me);
                                me->SummonGameObject(GO_STAIRS_ORGRIM_HAMMER, 5225.65f, 1589.58f, 808.474f, 5.89035f, 0, 0, 0.195158f, -0.980772f, 1*DAY);
                                me->SummonGameObject(GO_STAIRS_ORGRIM_HAMMER, 5239.94f, 1624.07f, 785.724f, 5.89035f, 0, 0, 0.195158f, -0.980772f, 1*DAY);
                                me->SummonGameObject(GO_STAIRS_ORGRIM_HAMMER, 5233.42f, 1608.33f, 796.217f, 5.89035f, 0, 0, 0.195158f, -0.980772f, 1*DAY);
                            }
                            break;
                        case EVENT_OUTRO_4:
                            if(instance->GetData(DATA_TEAM_IN_INSTANCE) == ALLIANCE)
                            {
                                ...
                                me->SummonGameObject(DUNGEON_MODE(GO_CAPTAIN_CHEST_2, GO_CAPTAIN_CHEST_4), 5230.11f, 1656.62f, 784.30f, 0.82f, 0, 0, 0, 0, 100000);
                            } else
                            {
                                ...
                                me->SummonGameObject(DUNGEON_MODE(GO_CAPTAIN_CHEST_1, GO_CAPTAIN_CHEST_3), 5230.11f, 1656.62f, 784.30f, 0.82f, 0, 0, 0, 0, 100000);
                            }
                            me->SummonGameObject(GO_PORTAL, 5250.96f, 1639.36f, 784.302f, 1.44458f, 0, 0, 0, 0, 100000);
                            break;
                    }
                }
