...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetInstanceAI<npc_argent_monkAI>(creature);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetInstanceAI<npc_argent_lightwielderAI>(creature);
    }
};
...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetInstanceAI<npc_argent_priestAI>(creature);
    }
};
