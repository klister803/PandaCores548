...
public:
    ...
    {
        boss_lavanthorAI(CreaturePtr creature) : ScriptedAI(creature)
        {
        ...
        void EnterCombat(UnitPtr /*who*/)
        {
            if (instance)
            {
            if (GameObjectPtr pDoor = instance->instance->GetGameObject(instance->GetData64(DATA_LAVANTHOR_CELL)))
