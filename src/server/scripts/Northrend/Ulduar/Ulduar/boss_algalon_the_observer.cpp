...
class ActivateLivingConstellation : public BasicEvent
{
    public:
        ...
        bool Execute(uint64 execTime, uint32 /*diff*/)
        {
            ...
            _owner->CastSpell(NULLUNIT, SPELL_TRIGGER_3_ADDS, TRIGGERED_FULL_MASK);
...
class CosmicSmashDamageEvent : public BasicEvent
{
    public:
        ...
        bool Execute(uint64 /*execTime*/, uint32 /*diff*/)
        {
            _caster->CastSpell(NULLUNIT, SPELL_COSMIC_SMASH_TRIGGERED, TRIGGERED_FULL_MASK);
            return true;
        }
...
class SummonUnleashedDarkMatter : public BasicEvent
{
    public:
        ...
        bool Execute(uint64 execTime, uint32 /*diff*/)
        {
            _caster->CastSpell(NULLUNIT, SPELL_SUMMON_UNLEASHED_DARK_MATTER, TRIGGERED_FULL_MASK);
        ...
        struct boss_algalon_the_observerAI : public BossAI
        {
            ...
            void JustSummoned(CreaturePtr summon)
            {
                ...
                switch (summon->GetEntry())
                {
                    ...
                    case NPC_BLACK_HOLE:
                        summon->SetReactState(REACT_PASSIVE);
                        summon->CastSpell(NULLUNIT, SPELL_BLACK_HOLE_TRIGGER, TRIGGERED_FULL_MASK);
                        summon->CastSpell(summon, SPELL_CONSTELLATION_PHASE_TRIGGER, TRIGGERED_FULL_MASK);
                        summon->CastSpell(NULLUNIT, SPELL_BLACK_HOLE_EXPLOSION);
    ...
    public:
        ...
        struct npc_living_constellationAI : public CreatureAI
        {
            ...
            void SpellHit(UnitPtr caster, SpellInfo const* spell)
            {
                ...
                caster->CastSpell(NULLUNIT, SPELL_BLACK_HOLE_CREDIT, TRIGGERED_FULL_MASK);
