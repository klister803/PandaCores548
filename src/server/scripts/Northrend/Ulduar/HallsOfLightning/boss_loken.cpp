    ...
    struct boss_lokenAI : public ScriptedAI
    {
        ...
        void Reset()
        {
            ...
            if (instance)
            {
                ...
                instance->DoStopTimedAchievement(CRITERIA_TIMED_TYPE_EVENT2, ACHIEV_TIMELY_DEATH_START_EVENT);
            }
        }
        ...
        void EnterCombat(Unit* /*who*/)
        {
            ...
            if (instance)
            {
                ...
                instance->DoStartTimedAchievement(CRITERIA_TIMED_TYPE_EVENT2, ACHIEV_TIMELY_DEATH_START_EVENT);
            }
        }
