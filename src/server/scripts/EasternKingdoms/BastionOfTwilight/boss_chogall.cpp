...
enum Spells
{
    ...
    SPELL_CONVERSION_25                            = 93203,
    SPELL_CONVERSION_10H                        = 93204,
    SPELL_CONVERSION_25H                        = 93205,
    SPELL_WORSHIPPING                            = 91317,
    SPELL_WORSHIPPING_25                        = 93365,
    SPELL_WORSHIPPING_10H                        = 93366,
    SPELL_WORSHIPPING_25H                        = 93367,
    SPELL_TWISTED_DEVOTION                      = 91331,
    SPELL_TWISTED_DEVOTION_25                   = 93206,
    SPELL_TWISTED_DEVOTION_10H                  = 93207,
    ...
    SPELL_FIRE_DESTRUCTION_25                    = 93264,
    SPELL_FIRE_DESTRUCTION_10H                    = 93265,
    SPELL_FIRE_DESTRUCTION_25H                    = 93266,
    SPELL_EMPOWERED_SHADOWS                        = 81572,
    SPELL_EMPOWERED_SHADOWS_25                    = 93218,
    SPELL_EMPOWERED_SHADOWS_10H                    = 93219,
    SPELL_EMPOWERED_SHADOWS_25H                    = 93220,
    SPELL_UNLEASHED_SHADOWS_DMG                    = 81571,
    SPELL_UNLEASHED_SHADOWS_DMG_25                = 93221,
    SPELL_UNLEASHED_SHADOWS_DMG_10H                = 93222,
    SPELL_UNLEASHED_SHADOWS_DMG_25H                = 93223,
    SPELL_CORRUPTING_CRASH                        = 81685,
    SPELL_CORRUPTING_CRASH_25                    = 93178,
    SPELL_CORRUPTING_CRASH_10H                    = 93179,
    SPELL_CORRUPTING_CRASH_25H                    = 93180,
    SPELL_DEPRAVITY                                = 81713,
    SPELL_DEPRAVITY_25                            = 93175,
    SPELL_DEPRAVITY_10H                            = 93176,
    SPELL_DEPRAVITY_25H                            = 93177,
    SPELL_FESTER_BLOOD                            = 82299,
    SPELL_FESTERING_BLOOD                        = 82914,
    SPELL_SPRAYED_CORRUPTION                    = 82919,
    SPELL_SPRAYED_CORRUPTION_25                    = 93108,
    SPELL_SPRAYED_CORRUPTION_10H                = 93109,
    SPELL_SPRAYED_CORRUPTION_25H                = 93110,
    SPELL_FESTER_BLOOD_SCRIPT                    = 82337,
    SPELL_SPILLED_BLOOD_OF_THE_OLD_GOD            = 81757,
    SPELL_SPILLED_BLOOD_OF_THE_OLD_GOD_DMG        = 81761,
    SPELL_SPILLED_BLOOD_OF_THE_OLD_GOD_DMG_25    = 93172,
    SPELL_SPILLED_BLOOD_OF_THE_OLD_GOD_DMG_10H    = 93173,
    SPELL_SPILLED_BLOOD_OF_THE_OLD_GOD_DMG_25H    = 93174,
    ...
    SPELL_BLAZE_DMG_25                            = 93212,
    SPELL_BLAZE_DMG_10H                            = 93213,
    SPELL_BLAZE_DMG_25H                            = 93214,
    SPELL_CORRUPTION_OF_THE_OLD_GOD                = 82361,
    SPELL_CORRUPTION_OF_THE_OLD_GOD_DMG            = 82363,
    SPELL_CORRUPTION_OF_THE_OLD_GOD_DMG_25        = 93169,
    SPELL_CORRUPTION_OF_THE_OLD_GOD_DMG_10H        = 93170,
    SPELL_CORRUPTION_OF_THE_OLD_GOD_DMG_25H        = 93171,
    SPELL_CORRUPTION_OF_THE_OLD_GOD_VISUAL        = 82356,
    SPELL_CONSUME_BLOOD_OF_THE_OLD_GOD            = 82630,
    SPELL_DARKENED_CREATIONS                    = 82414,
    SPELL_DARKENED_CREATIONS_25                    = 93160,
    SPELL_DARKENED_CREATIONS_10H                = 93161,
    SPELL_DARKENED_CREATIONS_25H                = 93162,
    SPELL_DARKENED_CREATIONS_SUM                = 82433,
    SPELL_DEBILITATING_BEAM                        = 82411,
    SPELL_DEBILITATING_BEAM_25                    = 93132,
    SPELL_DEBILITATING_BEAM_10H                    = 93133,
    SPELL_DEBILITATING_BEAM_25H                    = 93134,
                ...
                void DoCorruption(DoCorruptionTypes type)
                {
                    ...
                    case CORRUPTION_INIT:
                        for (Map::PlayerList::const_iterator itr = pList.begin(); itr != pList.end(); ++itr)
                        {
                            ...
                            pPlayer->SetMaxPower(POWER_ALTERNATE_POWER, 100);
                        }
                        break;
        ...
        struct npc_chogall_darkened_creationAI : public Scripted_NoMovementAI
        {
            ...
            void SpellHit(Unit* caster, SpellInfo const* spell)
            {
                ...
                if (me->GetCurrentSpell(CURRENT_GENERIC_SPELL)->m_spellInfo->Id == SPELL_DEBILITATING_BEAM ||
                    me->GetCurrentSpell(CURRENT_GENERIC_SPELL)->m_spellInfo->Id == SPELL_DEBILITATING_BEAM_25 ||
                    me->GetCurrentSpell(CURRENT_GENERIC_SPELL)->m_spellInfo->Id == SPELL_DEBILITATING_BEAM_10H ||
                    me->GetCurrentSpell(CURRENT_GENERIC_SPELL)->m_spellInfo->Id == SPELL_DEBILITATING_BEAM_25H)
                    for (uint8 i = 0; i < 3; ++i)
