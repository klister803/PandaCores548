...
enum Spells
{
    ...
    SPELL_BLACKOUT_25                = 92876,
    SPELL_BLACKOUT_10H                = 92877,
    SPELL_BLACKOUT_25H                = 92878,
    SPELL_BLACKOUT_DMG                = 86825,
    SPELL_BLACKOUT_DMG_25            = 92879,
    SPELL_BLACKOUT_DMG_10H            = 92880,
    SPELL_BLACKOUT_DMG_25H            = 92881,
    SPELL_DEVOURING_FLAMES            = 86840,
    SPELL_DEVOURING_FLAMES_DMG        = 86844,
    SPELL_DEVOURING_FLAMES_DMG_25    = 92872,
    SPELL_DEVOURING_FLAMES_DMG_10H    = 92873,
    SPELL_DEVOURING_FLAMES_DMG_25H    = 92874,
    SPELL_TWILIGHT_METEORITE        = 86013,
    SPELL_TWILIGHT_METEORITE_25        = 92859,
    SPELL_TWILIGHT_METEORITE_10H    = 92860,
    SPELL_TWILIGHT_METEORITE_25H    = 92861,
    SPELL_TWILIGHT_METEORITE_DMG    = 86014,
    SPELL_TWILIGHT_METEORITE_DMG_25    = 92863,
    SPELL_TWILIGHT_METEORITE_DMG_10H= 92864,
    SPELL_TWILIGHT_METEORITE_DMG_25H= 92865,
    ...
    SPELL_ENGULFING_MAGIC_25                        = 92912,
    SPELL_ENGULFING_MAGIC_10H                        = 92913,
    SPELL_ENGULFING_MAGIC_25H                        = 92914,
    SPELL_ENGULFING_MAGIC_AURA                        = 86622,
    SPELL_ENGULFING_MAGIC_AURA_25                    = 95639,
    SPELL_ENGULFING_MAGIC_AURA_10H                    = 95640,
    SPELL_ENGULFING_MAGIC_AURA_25H                    = 95641,
    ...
    SPELL_FABOLOUS_FLAMES_DMG_25                    = 92907,
    SPELL_FABOLOUS_FLAMES_DMG_10H                    = 92908,
    SPELL_FABOLOUS_FLAMES_DMG_25H                    = 92909,
    SPELL_TWILIGHT_BLAST                            = 86369,
    SPELL_TWILIGHT_BLAST_25                            = 92898,
    SPELL_TWILIGHT_BLAST_10H                        = 92899,
    SPELL_TWILIGHT_BLAST_25H                        = 92900,
    SPELL_TWILIGHT_BLAST_DMG                        = 86371,
    SPELL_TWILIGHT_BLAST_DMG_25                        = 92903,
    SPELL_TWILIGHT_BLAST_DMG_10H                    = 92904,
    SPELL_TWILIGHT_BLAST_DMG_25H                    = 92905,
    ...
    SPELL_DAZZLING_DESTRUCTION_SUMMON_MISSILE_25    = 92923,
    SPELL_DAZZLING_DESTRUCTION_SUMMON_MISSILE_10H    = 92924,
    SPELL_DAZZLING_DESTRUCTION_SUMMON_MISSILE_25H    = 92925,
    SPELL_DAZZLING_DESTRUCTION_SUMMON                = 86385,
    SPELL_DAZZLING_DESTRUCTION_MISSILE                = 86386,
    SPELL_DAZZLING_DESTRUCTION_MISSILE_25            = 92920,
    SPELL_DAZZLING_DESTRUCTION_MISSILE_10H            = 92921,
    SPELL_DAZZLING_DESTRUCTION_MISSILE_25H            = 92922,
    SPELL_DAZZLING_DESTRUCTION_DMG                    = 86406,
    SPELL_DAZZLING_DESTRUCTION_DMG_25                = 92926,
    SPELL_DAZZLING_DESTRUCTION_DMG_10H                = 92927,
    SPELL_DAZZLING_DESTRUCTION_DMG_25H                = 92928,
    ...
    SPELL_UNSTABLE_TWILIGHT_DMG_25                    = 92882,
    SPELL_UNSTABLE_TWILIGHT_DMG_10H                    = 92883,
    SPELL_UNSTABLE_TWILIGHT_DMG_25H                    = 92884,
    SPELL_TWILIGHT_ZONE                                = 86210,
    SPELL_TWILIGHT_ZONE_DMG                            = 86214,
    SPELL_TWILIGHT_ZONE_DMG_25                        = 92885,
    SPELL_TWILIGHT_ZONE_DMG_10H                        = 92886,
    SPELL_TWILIGHT_ZONE_DMG_25H                        = 92887,
    SPELL_TWILIGHT_RIFT_CHANNEL                        = 93017,
    SPELL_TWILIGHT_RIFT_10H                            = 93010,
    SPELL_TWILIGHT_RIFT_25H                            = 93037,
    SPELL_RIFT_BLAST_10H                            = 93019,
    SPELL_RIFT_BLAST_25H                            = 93020,
    ...
    public:
        ...
        struct boss_theralionAI : public BossAI
        {
            ...
            void Reset()
            {
                ...
                instance->DoRemoveAurasDueToSpellOnPlayers(SPELL_TWILIGHT_ZONE_DMG_25);
                instance->DoRemoveAurasDueToSpellOnPlayers(SPELL_TWILIGHT_ZONE_DMG_10H);
...
class npc_collapsing_twilight_portal : public CreatureScript
{
    public:
        ...
        bool OnGossipHello(Player* pPlayer, Creature* creature)
        {
            ...
            pPlayer->RemoveAurasDueToSpell(SPELL_TWILIGHT_ZONE_DMG_25);
            pPlayer->RemoveAurasDueToSpell(SPELL_TWILIGHT_ZONE_DMG_10H);
            pPlayer->RemoveAurasDueToSpell(SPELL_TWILIGHT_ZONE_DMG_25H);
            return true;
        }
        ...
        struct npc_dazzling_destruction_stalkerAI : public Scripted_NoMovementAI
        {
            ...
            void SpellHit(Unit* caster, SpellEntry const* spell)
            {
                if (spell->Id == SPELL_DAZZLING_DESTRUCTION_DMG ||
                    ...
                    spell->Id == SPELL_DAZZLING_DESTRUCTION_DMG_10H ||
                    spell->Id == SPELL_DAZZLING_DESTRUCTION_DMG_25H)
                me->DespawnOrUnsummon();
            }
        };
};
    ...
    public:
        ...
        class spell_valiona_twilight_flame_dmg_2_SpellScript : public SpellScript
        {
            ...
            void HandleScript(SpellEffIndex effIndex)
            {
                ...
                if (!GetHitUnit()->HasAura(SPELL_TWILIGHT_SHIFT_AURA_1) &&
                    !GetHitUnit()->HasAura(SPELL_TWILIGHT_SHIFT_AURA_25_1) &&
                    !GetHitUnit()->HasAura(SPELL_TWILIGHT_SHIFT_AURA_10H_1) &&
                    !GetHitUnit()->HasAura(SPELL_TWILIGHT_SHIFT_AURA_25H_1) &&
                    !GetHitUnit()->HasAura(SPELL_TWILIGHT_SHIFT_AURA_2) &&
                    !GetHitUnit()->HasAura(SPELL_TWILIGHT_SHIFT_AURA_25_2) &&
                    !GetHitUnit()->HasAura(SPELL_TWILIGHT_SHIFT_AURA_10H_2) &&
                    !GetHitUnit()->HasAura(SPELL_TWILIGHT_SHIFT_AURA_25H_2))
