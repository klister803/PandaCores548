...
#include "Group.h"
/*
UPDATE  `creature_template` SET  `faction_A` =  '14', `faction_H` =  '14', `ScriptName` =  'boss_coren_direbrew' WHERE `entry` =23872 LIMIT 1 ;
        ...
        struct boss_coren_direbrewAI : public BossAI
        {
            ...
            void JustDied(Unit* /*victim*/)
            {
                if (instance)
                {
                    ...
                    LFGDungeonEntry const* dungeon = sLFGDungeonStore.LookupEntry(287); //lfg id
