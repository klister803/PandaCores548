                ...
                if (StormCount < 10 && StormCount > 1)
                {
                    ...
                    for (std::list<Unit*>::const_iterator i = tempUnitMap.begin(); i != tempUnitMap.end(); ++i)
                    {
                        if (!Cloud->IsWithinDist(*i, 6, false))
                            Cloud->CastCustomSpell(*i, 43137, &bp0, NULL, NULL, NULL, NULL, NULL, true, 0, NULLAURA_EFFECT, me->GetGUID());
                    }
                    // visual
                    float x, y, z;
                    z = me->GetPositionZ();
                    for (uint8 i = 0; i < 5+rand()%5; ++i)
                    {
                        ...
                        if (Unit* trigger = me->SummonTrigger(x, y, z, 0, 2000))
                        {
                            ...
                            if (Cloud)
                                Cloud->CastCustomSpell(trigger, /*43661*/43137, &bp0, NULL, NULL, NULL, NULL, NULL, true, 0, NULLAURA_EFFECT, Cloud->GetGUID());
                        }
                    }
                }
                ++StormCount;
