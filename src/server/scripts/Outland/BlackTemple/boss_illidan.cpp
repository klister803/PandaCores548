    ...
    struct boss_illidan_stormrageAI : public ScriptedAI
    {
        ...
        void SummonMaiev()
        {
            ...
            if (!MaievGUID) // If Maiev cannot be summoned, reset the encounter and post some errors to the console.
            {
                ...
                TC_LOG_ERROR("server", "SD2 ERROR: Unable to summon Maiev Shadowsong (entry: 23197). Check your database to see if you have the proper SQL for Maiev Shadowsong (entry: 23197)");
            }
        }
