...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PREPARE_STATEMENT(CHAR_SAVE_BATTLE_PET_SLOTS, "REPLACE INTO character_battle_pet (guid, ownerAccID, slot, locked) VALUES (?, ?, ?, ?)", CONNECTION_ASYNC);
    PREPARE_STATEMENT(CHAR_LOAD_BATTLE_PET_SLOTS, "SELECT guid, slot, locked FROM character_battle_pet WHERE ownerAccID = ?", CONNECTION_ASYNC);
