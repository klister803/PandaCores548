...
void CharacterDatabaseConnection::DoPrepareStatements()
{
    ...
    PREPARE_STATEMENT(CHAR_SEL_PET_SLOTS_CHANGE, "SELECT slot, entry, id, PetType FROM character_pet WHERE owner = ? AND id = ?", CONNECTION_ASYNC);
    ...
    "health, power1, power2, power3, power4, power5, instance_id, speccount, activespec, specialization1, specialization2, exploredZones, equipmentCache, knownTitles, actionBars, currentpetslot, petslot, grantableLevels, resetspecialization_cost, resetspecialization_time FROM characters WHERE guid = ?", CONNECTION_ASYNC)
    ...
    "power4, power5, latency, speccount, activespec, specialization1, specialization2, exploredZones, equipmentCache, knownTitles, actionBars, currentpetslot, petslot, grantableLevels) VALUES "
    "(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", CONNECTION_ASYNC);
    ...
    "equipmentCache=?,knownTitles=?,actionBars=?,currentpetslot=?,petslot=?,grantableLevels=?,online=?, resetspecialization_cost = ?, resetspecialization_time = ? WHERE guid=?", CONNECTION_ASYNC);
