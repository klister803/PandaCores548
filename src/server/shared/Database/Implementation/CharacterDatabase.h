...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_SAVE_BATTLE_PET_JOURNAL,
    CHAR_LOAD_BATTLE_PET_JOURNAL,
    CHAR_DEL_BATTLE_PET_JOURNAL,
    CHAR_SAVE_BATTLE_PET_SLOTS,
    CHAR_LOAD_BATTLE_PET_SLOTS,
    ...
    CHAR_SEL_PLAYER_GORESPAWN,
    CHAR_INS_PLAYER_GORESPAWN,
