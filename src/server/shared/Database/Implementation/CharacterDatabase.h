...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_UPDATE_GUILD_MEMBER_REP,
    CHAR_UPDATE_GUILD_MEMBER_ACTIV,
    CHAR_UPD_GUILD_MEMBERS_ACHIVPOINTS,
    CHAR_INS_GUILD_RANK,
    ...
    CHAR_UPD_PLAYER_ARCHAELOGY,
    CHAR_REP_PLAYER_ARCHAELOGY,
    CHAR_SEL_PLAYER_ARCHPROJECT,
    CHAR_UPD_PLAYER_ARCHPROJECT,
    CHAR_REP_PLAYER_ARCHPROJECT,
    CHAR_SEL_PLAYER_ARCHPROJECTHISTORY,
    CHAR_UPD_PLAYER_ARCHPROJECTHISTORY,
    CHAR_REP_PLAYER_ARCHPROJECTHISTORY,
