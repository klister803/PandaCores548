...
class FunctionProcessor
{
    public:
        ...
        uint32 SizeQueue() const { return m_functions_queue.size(); }
        void AddTimedDelayedOperation(uint64 t_offset, std::function<void()> && function) { AddFunction(std::move(function), m_time + t_offset); };
