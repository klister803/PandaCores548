...
private:
    ...
    dtMeshTile* GetposLookup(int _h) const
    {
        //TRINITY_READ_GUARD(ACE_Thread_Mutex, i_m_posLookupLock);
        dtMeshTile* _tile = m_posLookup[_h];
        return _tile;
    }

    void SetposLookup(dtMeshTile* _tiles, int _h)
    {
        //TRINITY_WRITE_GUARD(ACE_Thread_Mutex, i_m_posLookupLock);
        m_posLookup[_h] = _tiles;
        //return _tiles;
    }
